...
Response::Response( Request const & request, std::string const & filePath ) :
...
_filePath( filePath ) {
	...
	if ( request.method() != "GET" )
		this->_finalResponse = this->_version + METHOD_NOT_ALLOWED + "\r\n\r\n405 Method Not Allowed\r\n";

	else if (!pathExists(filePath)) {
		std::cout << "\r\e[K\e[1;35m" << this->_filePath << " doesn't exists\e[0m" << std::endl;
		this->_finalResponse = this->_version + NOT_FOUND + "\r\n\r\n404 Not Found\r\n";
	}

	if (isDirectory(filePath)) {

		std::cout << "\r\e[K\e[1;35m" << filePath << " is a Directory\e[0m" << std::endl;
		this->_finalResponse = this->_version + FORBIDDEN + "\r\n\r\n403 Forbidden\r\n";
